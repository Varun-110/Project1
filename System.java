...
public class System extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {
        try{
            ...
            String sql="select * from voterlist where Id='"+VoterId+"',Password='"+password+"'";
            ResultSet rs=st.executeQuery(sql);
            if(rs.next()){
                String sql1="insert into voted values('"+VoterId+"','"+password+"')";
        ...
        if(jTextField1.getText().equals("")){
            ...
            JOptionPane.showMessageDialog(rootPane,"Please Enter Voter ID");
        }
        else if(jRadioButton1.isSelected()){
            p1++;
            JOptionPane.showMessageDialog(rootPane,"Succesfully Voted to Party A");
        }
        else if(jRadioButton2.isSelected()){
            p2++;
            JOptionPane.showMessageDialog(rootPane,"Succesfully Voted to Party B");
        }
        else if(jRadioButton3.isSelected()){
            p3++;
            JOptionPane.showMessageDialog(rootPane,"Succesfully Voted to Party C");
        }
        else{
